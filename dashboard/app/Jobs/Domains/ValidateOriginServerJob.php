...
class ValidateOriginServerJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function __construct(
        ...
        public readonly string $requestedDomain,
        public readonly ?string $originServer = null
    ) {}

    public function handle(DomainProvisioningService $provisioning): void
    {
        $provisioning->validateOriginServer($this->tenantDomainId, $this->requestedDomain, $this->originServer);
    }
